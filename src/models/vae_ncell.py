...
import numpy as np
import random
from .NVAE import Residual_Cell_NVAE as encoder_cell
from .NVAE import Generative_Cell_NVAE as decoder_cell
...
"""
class VAE_Ncell(nn.Module):
    def __init__(self, imgChannels=1, featureDim=4096, zDim=256):
        super(VAE_Ncell, self).__init__()

       # Vae model made to match that in the Defence-VAE code base
        # Encoder
        self.encConv1 = nn.Conv2d(1, 128, kernel_size=5, stride=1, padding=2, bias= False)
        self.encConv1_bn = nn.BatchNorm2d(128)

        self.encN1 = encoder_cell(128,128)
        self.encN2 = encoder_cell(128,128)
        self.encN3 = encoder_cell(128,128)
        self.encN4 = encoder_cell(128,128)
        self.encN5 = encoder_cell(128,128)

        self.encConv2 = nn.Conv2d(128, 64, kernel_size=4, stride=2, padding=3, bias= False)
        ...
        # Latent space
        self.mu_layer = nn.Linear(4096, 128)
        self.logvar_layer = nn.Linear(4096, 128)

        # Decoder
        self.fc3 = nn.Linear(128, 4096)
        self.fc3_bn = nn.BatchNorm1d(4096)
        self.deconv1 = nn.ConvTranspose2d(256, 1028, kernel_size=4, stride=2, padding=1, bias= False)
        self.deconv1_bn = nn.BatchNorm2d(1028)
                
        self.decN1 = decoder_cell(1028,E_param=2)
        self.decN2 = decoder_cell(1028,E_param=2)
        self.decN3 = decoder_cell(1028,E_param=2)
        self.decN4 = decoder_cell(1028,E_param=2)
        self.decN5 = decoder_cell(1028,E_param=2)
        
        self.deconv2 = nn.ConvTranspose2d(1028, 128, kernel_size=4, stride=2, padding=1, bias= False)
